        ...
        <section className={styles.section}>
            <Container className={styles.grid}>
                <TextReveal className={styles.paragraph}>
                    I&apos;ve worked both in front-end and back-end development, so I&apos;m perfectly capable of developing user-friendly and responsible front-ends and scalable and efficient back-ends.
                </TextReveal>
